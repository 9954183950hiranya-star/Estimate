...
- Volume I: `DSR_Vol_1_Civil 2023.pdf`, bounded group `2.0` with item groups `2.1` through `2.9`, including cross-page `2.9.3`; inspected PDF pages 100-103. Retained rows are on PDF pages 102-103, printed pages 91-92.
- Volume II: `DSR_Vol_2_Civil  2023.pdf`, bounded groups `13.1`, `13.2`, `13.16`, `13.28`, and `13.39` under `13.0 FINISHING`, including all children in those groups; inspected PDF pages 14-17, printed pages 217-220.
...
- Volume I: Actual parent records for `2.1`, `2.2`, `2.3`, `2.6`, `2.7`, `2.8`, and `2.9` are included. All selected children are included, including `2.7.3` and cross-page `2.9.3`.
